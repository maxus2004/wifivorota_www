...
window.onload = async function () {
    ...
    document.getElementById('type_select').onchange = onSelect
}

function onSelect() {
    if (document.getElementById('button_select').value == "" || document.getElementById('type_select').value == "") {
